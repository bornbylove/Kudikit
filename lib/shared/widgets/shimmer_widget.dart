      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: [
              _ShimmerBox(width: AppLayout.scaleWidth(context, 70), height: 14),
              SizedBox(height: AppLayout.scaleHeight(context, 6)),
              _ShimmerBox(width: AppLayout.scaleWidth(context, 50), height: 11),
            ],
          ),
        ],
      ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          _ShimmerBox(width: AppLayout.scaleWidth(context, 180), height: 14),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          _ShimmerBox(width: AppLayout.scaleWidth(context, 80), height: 16),
          _ShimmerBox(width: AppLayout.scaleWidth(context, 60), height: 12),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: AppLayout.scaleHeight(context, 12)),
            _ShimmerBox(width: AppLayout.scaleWidth(context, 180), height: 32),
      ...
      child: Row(
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.end,
            children: [
              _ShimmerBox(width: AppLayout.scaleWidth(context, 70), height: 13),
              SizedBox(height: AppLayout.scaleHeight(context, 5)),
              Container(
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      _ShimmerBox(
                          width: AppLayout.scaleWidth(context, 130),
                          height: 16),
                      SizedBox(height: AppLayout.scaleHeight(context, 6)),
                      _ShimmerBox(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: AppLayout.scaleWidth(context, 14)),
                      _ShimmerBox(
                          width: AppLayout.scaleWidth(context, 160),
                          height: 14),
                    ],
                  ),
                ),
