...
class _TransactionPinBottomSheetState
  ...
  Future<void> _verifyPin() async {
    ...
    try {
      final isValid =
          await TransactionPinService.instance.verifyTransactionPin(_pin);
      if (!mounted) return;
          ...
          child: Column(
            ...
            children: [
              ...
              if (_isVerifying)
                Padding(
                    padding:
                        EdgeInsets.only(top: AppLayout.scaleHeight(context, 8)),
          ...
          return Padding(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                color: filled
                    ? (_showError ? Colors.red : AppColors.primaryTeal)
                    : Colors.grey[400],
              ),
            ),
          );
  ...
  Widget _keyBtn(BuildContext context,
